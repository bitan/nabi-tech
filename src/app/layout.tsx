  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} ${playfair.variable} h-full antialiased`}>
      ...
      <body className="min-h-full flex flex-col bg-[#080808]">
        ...
        <DotPattern className="fixed w-full text-white/[0.12] [mask-image:radial-gradient(ellipse_100%_100%_at_50%_0%,white_40%,transparent_100%)]" cr={1.5} width={24} height={24} />
        <ShutterIntro />
        <Navbar />
        <PageReveal>
