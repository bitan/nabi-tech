  ...
  return (
    <>
      ...
      <section aria-label="What we help with" className="relative bg-[#080808] py-14 px-5 sm:px-8 overflow-hidden">
        <DotPattern className="absolute text-white/[0.10] [mask-image:radial-gradient(ellipse_at_center,white_30%,transparent_75%)]" />
        <BlurFade delay={0.1}>
      ...
      <section aria-label="Key statistics" className="relative bg-[#080808] py-16 px-5 sm:px-8 overflow-hidden">
        <DotPattern className="absolute text-white/[0.08] [mask-image:radial-gradient(ellipse_at_center,white_40%,transparent_80%)]" />
      ...
      <section aria-labelledby="services-heading" className="relative bg-[#080808] py-24 px-5 sm:px-8 overflow-hidden">
        <DotPattern className="absolute text-white/[0.07] [mask-image:radial-gradient(ellipse_80%_60%_at_50%_0%,white_40%,transparent_100%)]" />
      ...
      <section aria-labelledby="why-heading" className="relative bg-[#080808] py-24 px-5 sm:px-8 overflow-hidden">
        <DotPattern className="absolute text-white/[0.07] [mask-image:radial-gradient(ellipse_at_right,white_20%,transparent_70%)]" />
      ...
      <section aria-labelledby="demos-heading" className="relative bg-[#080808] py-24 px-5 sm:px-8 overflow-hidden">
        <DotPattern className="absolute text-white/[0.07] [mask-image:radial-gradient(ellipse_at_left,white_20%,transparent_70%)]" />
        <div className="max-w-6xl mx-auto">
          <BlurFade delay={0.05}>
      ...
      <section aria-labelledby="cta-heading" className="relative bg-[#080808] py-24 px-5 sm:px-8 overflow-hidden">
        <DotPattern className="absolute text-white/[0.06] [mask-image:radial-gradient(ellipse_at_center,white_30%,transparent_70%)]" />
